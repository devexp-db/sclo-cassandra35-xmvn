...
# XXX
find . -name pom.xml -exec sed -i 's|<version>2.1.1</version>|<version>2.1.1.fake</version>|' {} +
cat > ${RPM_BUILD_DIR}/xmvn-2.1.1/.xmvn/config.d/javapackages-config-00003.xml << "XXX"
<?xml version='1.0' encoding='utf-8'?>
<configuration xmlns="http://fedorahosted.org/xmvn/CONFIG/2.0.0">
<!--XMvn configuration file generated by javapackages.xmvn_config  (part of javapackages-tools)--><buildSettings><skipTests>true</skipTests></buildSettings></configuration>
XXX
cat > ${RPM_BUILD_DIR}/xmvn-2.1.1/.xmvn/config.d/javapackages-config-00004.xml << "XXX"
<?xml version='1.0' encoding='utf-8'?>
<configuration xmlns="http://fedorahosted.org/xmvn/CONFIG/2.0.0">
<!--XMvn configuration file generated by javapackages.xmvn_config  (part of javapackages-tools)--><artifactManagement><rule><artifactGlob><classifier>*?</classifier></artifactGlob><optional>true</optional><targetPackage>__noinstall</targetPackage></rule></artifactManagement></configuration>
XXX
cat > ${RPM_BUILD_DIR}/xmvn-2.1.1/.xmvn/config.d/javapackages-config-00005.xml << "XXX"
<?xml version='1.0' encoding='utf-8'?>
<configuration xmlns="http://fedorahosted.org/xmvn/CONFIG/2.0.0">
<!--XMvn configuration file generated by javapackages.xmvn_config  (part of javapackages-tools)--><artifactManagement><rule><artifactGlob><artifactId>{*}</artifactId></artifactGlob><targetPackage>@1</targetPackage></rule></artifactManagement></configuration>
XXX
%{?scl:EOF}
...
#%%mvn_build -s -f
# XXX
xmvn --batch-mode --offline -Dmaven.test.skip=true package org.fedoraproject.xmvn:xmvn-mojo:2.1.1:install org.apache.maven.plugins:maven-javadoc-plugin:aggregate org.fedoraproject.xmvn:xmvn-mojo:2.1.1:builddep
